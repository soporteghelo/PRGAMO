  ...
  return (
    <div className="group relative h-full w-full">
      ...
      >
        ...
        {/* Título */}
        <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-blue-300 transition-colors duration-300 leading-tight mb-2">
          {Titulo}
        </h3>
        
        {/* Descripción */}
        {Descripcion && (
          <p className="text-slate-300 text-xs leading-relaxed group-hover:text-slate-200 transition-colors duration-300 mb-2 sm:mb-3 line-clamp-2">
            {Descripcion}
          </p>
        )}
        ...
        <div className="mt-auto pt-2">
          <a
            ...
            className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white py-2 px-2 sm:px-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 group"
          >
            ...
            <span className="font-medium text-xs sm:text-sm">Quiero más información</span>
          </a>
        </div>
